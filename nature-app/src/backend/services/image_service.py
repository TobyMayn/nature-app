...
class ImageDownloader:
    ...
    #         layers=[layer],
    #         styles=[],
    #         srs='EPSG:25832', # WGS84 for lat/lon
    #         # bbox=[min_lon, min_lat, max_lon, min_lat],
    #         bbox=[706137.7710,6172363.2988,706827.6242,6173216.4145],
    ...
    #                 file_name = f"{layer}_{cur_lon}_{cur_lat}_{max_lon}_{max_lat}_{image_num}.png"
    #                 file_path = os.path.join(self.save_directory, file_name)
    #                 try:
    #                     self._download_tile(cur_lon, cur_lat, max_lon, max_lat, file_path, layer)
    #                     downloaded_paths.append(file_path)
    #                     image_num += 1
    #                 except Exception as e:
    #                     print(f"Failed downloading image: {file_name} : {e}")
